...
def reformat_data(window_data, pos_window):
    ms = "discoal 50 1 1000 -t 1000 -r 1000\n1 2 3\n\n//\nsegsites: {}\n".format(len(pos_window))
...
if __name__ == "__main__":
    ...
    for rep in range(args.repnum,args.repnum + 1,1):
        for timepoint in range(50000,50205,5):
            for locus in range(0,10,1):
                for window in range(0,21,1):
                    name1 = "replicate" + str(rep) + ".locus" + str(locus) +".window"+str(window) + ".timepoint" + str(timepoint) + ".0.msdata.txt"
                    name2 = "replicate" + str(rep) + ".locus" + str(locus) +".window"+str(window) + ".timepoint" + str(timepoint) + ".fvec"
                    name3 = "replicate" + str(rep) + ".locus" + str(locus) +".window"+str(window) + ".timepoint" + str(timepoint) + ".sh"
                    name4 = "replicate" + str(args.repnum) + ".stat.txt"
