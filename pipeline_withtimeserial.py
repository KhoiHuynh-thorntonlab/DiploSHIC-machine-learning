...
class Traj(object):
    ...
    def take_sample(self, pop):
            ...
            s = pop.sample(rng = rng, nsam=25,seperate=False)
    ...
    def __call__(self, pop):
        ...
        if self.timepoints >10*pop.N:
                    ...
                    for i, j in zip(self.samples, range(len(self.samples))):
                        with open(self.filename +self.timepoints + ".rep{}.window{}.txt".format(self.repid, j), "w") as f:
